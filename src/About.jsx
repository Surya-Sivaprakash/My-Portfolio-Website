...
const About = () => {
  return (
    <div id="About">
      <div className="mt-[21rem] ss:mt-[16rem] flex justify-center mb-[8rem] text-white text-[4.5rem] opacity-25 snine:mb-14 snine:mx-auto snine:text-center">
        About
      </div>
                  ...
                  <div>
                    <div className="flex justify-center items-center w-[3.25rem] h-[3.25rem] sfsf:w-[5.125rem] sfsf:h-[5.125rem] sff:w-[3.7rem] sff:h-[3.7rem]">
                      <a
                        ...
                        target="_blank"
                      >
                        <Icon iconName="github" width={"6vw"} height={"6vh"} />
                      </a>
                    </div>
                  </div>
                  <div>
